...
def main():
    """Demo the control flow analyzer for prober."""
    print("🔍 Control Flow Analyzer - Prober Demo")
    print("=" * 50)
    
    prober_path = "/opt/openproject/external/prober"
    analyzer = ControlFlowAnalyzer(prober_path)
