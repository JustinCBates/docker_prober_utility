"""Docker Prober Utility - Experimental package for Docker host probing."""#!/usr/bin/env python3

__version__ = "0.1.0""""

Docker Prober Utility - Flask Backend

# Import main functionalityMinimal HTTP/HTTPS backend for integration testing and deployment validation

from .main import main"""



__all__ = ["main"]from flask import Flask, jsonify, request
import json
import os
import subprocess
